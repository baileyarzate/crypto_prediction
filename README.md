...
- **Quantitative Performance**: Validation across multiple models using Mean Absolute Error (MAE) ![Model MAE Table](notes/images/model_performances.png)
- **Interpretability**: Dives into model feature influence using SHAP ![SHAP Plot](notes/images/model_feature_importance.png)
- Model Fit: Visual comparison showing how the best-performing models track the actual historical close price. ![Model Fit Plot](notes/images/actual_vs_predicted_close.png)
...
```
![Bitcoin Prediction Dashboard](notes/images/bitcoin_dashboard_predictions.png)
